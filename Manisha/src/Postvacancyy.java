...
l7=new JLabel("Post And View");

ImageIcon obj=new ImageIcon("image/jobvacancy.jpg");
...
b1.setBounds(45,220,100,40);

b2.setBounds(170,220,100,40);

b3.setBounds(65,280,150,30);

b4.setBounds(900,30,150,30);
