...
l8=new JLabel("Company Registration From");

ImageIcon img=new ImageIcon("image/registra.jpg");
...
String HR_Name=(String)t4.getText();
...
PreparedStatement ps=c.prepareStatement("insert into CompanyRegister values(?,?,?,?,?,?,?)");
